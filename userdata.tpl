{
  ...
  "RawConfig": {
    ...
    "ConfigArray": [
      ...
      "/c/l3/if 1/ena/ipver v4/addr ${adc_data_eni_private_ip}/mask 255.255.255.0",
      "/c/l3/if 2/ena/ipver v4/addr ${adc_servers_eni_private_ip}/mask 255.255.255.0/vlan 2",
      "/c/slb/pip/add ${adc_servers_eni_private_ip_PIP} 2",
